      ...
      <div style={containerStyle}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <SocialButton label="Continue with Apple" onClick={() => handleOAuth("apple")}>
            <svg width="20" height="20" viewBox="0 0 24 24">
              <path d="M16.365 1.43c-.8.1-1.74.56-2.3 1.2-.5.6-.94 1.44-.7 2.31 0 0 1.6.08 2.35-.62.74-.7.93-1.74.65-3z" fill="#000"/>
              <path d="M12.1 4.3c-1.8 0-3.5 1.1-4.4 1.1-1 .02-2.5-1.04-4.1-1.02C2.5 4.4.5 6.6.5 10c0 2.14.9 4.7 2.4 7.28 1.32 2.24 2.9 4.6 5.06 4.66 1.08.03 1.5-.7 2.8-.7 1.3 0 1.7.7 2.8.68 2.17-.03 3.73-2.39 5.06-4.64C23 14.7 24 12.22 24 10c0-3.5-2-5.6-5.6-5.6-1.6 0-2.96.98-3.3.98-.4 0-2.1-1.02-3-1.02z" fill="#000"/>
            </svg>
          </SocialButton>
        </div>
