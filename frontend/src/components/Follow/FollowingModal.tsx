...
// ADD ALL THE MISSING STYLE OBJECTS (same as FollowersModal)
    ...
    <div style={overlayStyle} onClick={onClose}>
      <div style={modalStyle} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={headerStyle}>
          <h3 style={titleStyle}>Following</h3>
          <button 
            onClick={onClose} 
        ...
        <div style={contentStyle}>
          {loading ? (
            <div style={loadingStyle}>Loading following...</div>
          ) : following.length === 0 ? (
              ...
              {following.map((follow) => (
                ...
                >
                  ...
                  <div style={userInfoStyle}>
                    <div style={userNameStyle}>{follow.profiles.full_name || 'Anonymous'}</div>
                    <div style={usernameStyle}>@{follow.profiles.username || 'user'}</div>
                    {follow.profiles.bio && (
                      <div style={bioStyle}>{follow.profiles.bio}</div>
                    )}
                  </div>
                </div>
              ))}
